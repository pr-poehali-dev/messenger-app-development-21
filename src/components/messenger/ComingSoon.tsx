...
const FEATURES: Feature[] = [
  ...
  },
  {
    id: "stories",
    title: "Истории",
    desc: "Уже работают! Загрузи фото в ленте сверху или во вкладке «Истории» — оно проживёт 24 часа и будет видно только твоим контактам. Можно увидеть кто смотрел.",
    icon: "Circle",
